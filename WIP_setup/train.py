...
TIME_BUDGET = 3600       # Target training timeline in seconds
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = get_dataloaders(base_folder, batch_size=BATCH_SIZE, transform=train_transform)
